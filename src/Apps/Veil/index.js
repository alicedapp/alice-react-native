...
//This is your main navigation folder where you setup the screens and tab navigation of your app
...
const HomeScreen2 = createStackNavigator({
  ...
  },
  {
    headerMode: 'none',
    navigationOptions: {
      tabBarIcon: ({ tintColor }) => <Icon icon={require('./Assets/checkbox-blank.png')} size={25}/>,
    },
  });
