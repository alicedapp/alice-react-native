...
class Explore extends React.Component {
  ...
  render() {
    ...
    if (this.state.bountiesInfo === null) {
      return (
        <View style={{
          flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#efefef',
        }}>
          <Image source={require('../../../Assets/aragon.png')} style={{ width: 80, height: 80, resizeMode: 'contain' }}/>
        </View>
      );
    }
    return (
      <View style={{ flex: 1, justifyContent: 'flex-start', alignItems: 'center' }}>
        <View style={{
          ...
          <ScrollView style={{ width, flex: 1 }}>
            {this.state.bountiesInfo.map((result) => {
                ...
                <View style={styles.bountyContainer}>
                  ...
                  <View style={{ flexDirection: 'row' }}>
                    <View style={{
                      ...
                      {result.fulfillments.map(category => (
                        <View style={{
